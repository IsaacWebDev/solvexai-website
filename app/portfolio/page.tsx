                ...
                {templates.map((template, i) => (
                  ...
                  >
                    <LiquidGlassCard intensity="light" className="overflow-hidden h-full border border-white/10 hover:border-white/20 transition-all">
                      {/* Placeholder visual */}
                      <div className={`h-48 md:h-56 bg-gradient-to-br ${template.color} relative flex items-center justify-center`}>
                        <div className="absolute inset-0 bg-black/30" />
                        <span className="relative text-white font-semibold text-xl">{template.name.split(' ')[0]}</span>
                      </div>
                      <div className="p-5">
